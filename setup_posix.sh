...
if [ -d "$forte_bin_dir" ]; then
  ...
  cmake -G "Unix Makefiles" \
    -DCMAKE_TOOLCHAIN_FILE=/home/felix/4diac-forte/toolchain-arm32.cmake \
    ...
    -DFORTE_EXTERNAL_MODULES_DIRECTORY=/home/felix/4diac-forte/ext_modules \
    -DFORTE_MODULE_EXTERNAL_gpiocontroller=ON \
    ../../
else
